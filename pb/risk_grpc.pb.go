...
const (
	RiskService_CheckAddress_FullMethodName = "/pb.RiskService/CheckAddress"
)
...
type RiskServiceClient interface {
	CheckAddress(ctx context.Context, in *RiskRequest, opts ...grpc.CallOption) (*RiskResponse, error)
}
...
func (c *riskServiceClient) CheckAddress(ctx context.Context, in *RiskRequest, opts ...grpc.CallOption) (*RiskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RiskResponse)
	err := c.cc.Invoke(ctx, RiskService_CheckAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RiskServiceServer interface {
	CheckAddress(context.Context, *RiskRequest) (*RiskResponse, error)
...
func (UnimplementedRiskServiceServer) CheckAddress(context.Context, *RiskRequest) (*RiskResponse, error) {
...
func _RiskService_CheckAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RiskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RiskServiceServer).CheckAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RiskService_CheckAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RiskServiceServer).CheckAddress(ctx, req.(*RiskRequest))
	}
...
var RiskService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.RiskService",
	HandlerType: (*RiskServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CheckAddress",
			Handler:    _RiskService_CheckAddress_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pb/risk.proto",
}
